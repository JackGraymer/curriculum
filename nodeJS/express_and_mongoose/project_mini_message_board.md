...
(Insert here some instructions to add this new created message at route new.js to the message array at route index.js, which is the one being displayed and needs to be updated to render the changes)
